...
\cellcolor{gray!6}{une matière première} & \cellcolor{gray!6}{a raw material}\\
un revenu & an income\\
...
\cellcolor{gray!6}{permettre à qn de faire} & \cellcolor{gray!6}{to allow sb to}\\
...
\cellcolor{gray!6}{bois d'œuvre} & \cellcolor{gray!6}{timber}\\
récolter & to harvest\\
\cellcolor{gray!6}{s'assurer, garantir} & \cellcolor{gray!6}{to ensure}\\
matière première & raw material\\
\addlinespace
\cellcolor{gray!6}{croître} & \cellcolor{gray!6}{to grow}\\
stocker & to store\\
\cellcolor{gray!6}{des centaines} & \cellcolor{gray!6}{hundreds}\\
autour & around\\
\cellcolor{gray!6}{tel que} & \cellcolor{gray!6}{such as}\\
\addlinespace
des vêtements & clothes\\
\cellcolor{gray!6}{ne ... plus} & \cellcolor{gray!6}{no longer}\\
endommager & to harm\\
\cellcolor{gray!6}{parvenir à} & \cellcolor{gray!6}{to manage to}\\
un tâche & an assignment\\
\addlinespace
\cellcolor{gray!6}{une règle} & \cellcolor{gray!6}{a rule}\\
une facture & an invoice\\
\cellcolor{gray!6}{autoriser} & \cellcolor{gray!6}{to allow}\\
un montant & an amount\\
\cellcolor{gray!6}{reconnaissant} & \cellcolor{gray!6}{grateful}\\
\addlinespace
une commande & an order\\
\cellcolor{gray!6}{une livraison} & \cellcolor{gray!6}{a delivery}\\
un service & a favour\\
\cellcolor{gray!6}{habituellement} & \cellcolor{gray!6}{usually}\\
flux de trésorerie & cash flow\\
\addlinespace
\cellcolor{gray!6}{la gestion} & \cellcolor{gray!6}{the management}\\
signifier & to stand for\\
\cellcolor{gray!6}{le soutien} & \cellcolor{gray!6}{the endorsement}\\
alors que & whereas\\
\cellcolor{gray!6}{attendez} & \cellcolor{gray!6}{hold on}\\
\addlinespace
...
\cellcolor{gray!6}{the conditions of when a customer should make payment} & \cellcolor{gray!6}{payment terms}\\
a document which shows how much a customer has to pay, for what and by when & an invoice\\
\cellcolor{gray!6}{when more time is allowed for something} & \cellcolor{gray!6}{an extension}\\
\addlinespace
proof that a delivery has been made & delivery confirmation\\
\cellcolor{gray!6}{the timing and amount of money coming in and going out of a company} & \cellcolor{gray!6}{cash flow}\\
an official or organisational rule & a regulation\\
\cellcolor{gray!6}{to show someone you are grateful for something they have done} & \cellcolor{gray!6}{to appreciate}\\
\bottomrule
\end{longtable}
...
\cellcolor{gray!6}{As-tu appelé le magasin hier ?} & \cellcolor{gray!6}{Did you call the shop yesterday?}\\
La semaine dernière, nous avons acheté un nouveau massicot. & Last week, we bought a new trimmer.\\
\cellcolor{gray!6}{As-tu besoin de plus d'autocollants ?} & \cellcolor{gray!6}{Do you need more stickers?}\\
\addlinespace
Nous devons expédier la commande maintenant. & We must send the order now.\\
\cellcolor{gray!6}{Quel type de pli voulez-vous ?} & \cellcolor{gray!6}{What type of fold do you want?}\\
Nous devons acheter des agrafes. & We must buy staples.\\
\cellcolor{gray!6}{Mon chef veut que le message soit clair.} & \cellcolor{gray!6}{My boss wants the message to be clear.}\\
Tu as fait une petite erreur. & You made a small mistake.\\
\addlinespace
\cellcolor{gray!6}{Cette imprimante a-t-elle des défauts ?} & \cellcolor{gray!6}{Does this printer have drawbacks?}\\
Le professeur veut que nous fassions un sondage. & The teacher wants us to do a poll.\\
\cellcolor{gray!6}{Parle-t-il français ?} & \cellcolor{gray!6}{Does he speak English?}\\
Nous appellerons l'entreprise la semaine prochaine. & We will call the company next week.\\
\cellcolor{gray!6}{Que regardes-tu ?} & \cellcolor{gray!6}{What are you looking at?}\\
\addlinespace
Je ne comprends pas ce qu'ils veulent. & I don't understand what they want.\\
\cellcolor{gray!6}{Je ne peux pas travailler sans ordinateur.} & \cellcolor{gray!6}{I can't work without a computer.}\\
Peux-tu me rappeler ? & Can you call me back?\\
\cellcolor{gray!6}{Avec qui es-tu en train de travailler ?} & \cellcolor{gray!6}{Who are you working with?}\\
Nous travaillons souvent avec des entreprises étrangères. & We often work with foreign companies.\\
\addlinespace
\cellcolor{gray!6}{Quel logiciel utilises-tu aujourd'hui ?} & \cellcolor{gray!6}{What software are you using today?}\\
Est-ce que ton chef parle anglais ? & Does your boss speak English?\\
\cellcolor{gray!6}{Où as-tu passé les vacances?} & \cellcolor{gray!6}{Where did you spend the holidays?}\\
...
\cellcolor{gray!6}{Où étudies-tu cette année ?} & \cellcolor{gray!6}{Where are you studying this year?}\\
J'étudie à l'École Estienne. & I am studying at Ecole Estienne.\\
\cellcolor{gray!6}{Que dois-tu faire cette semaine ?} & \cellcolor{gray!6}{What must you do this week?}\\
Je dois trouver un stage. & I must find an internship.\\
\addlinespace
\cellcolor{gray!6}{Le client a-t-il rappelé hier?} & \cellcolor{gray!6}{Did the customer call back yesterday?}\\
L'entreprise a commandé 10 000 cartes de visite la semaine dernière. & The company ordered 10,000 business cards last week.\\
\cellcolor{gray!6}{Il faut que je change l'encre de cette presse.} & \cellcolor{gray!6}{I must change the ink of that press.}\\
Que fais-tu ? & What are you doing?\\
\cellcolor{gray!6}{Je lis le manuel de notre nouveau logiciel.} & \cellcolor{gray!6}{I am reading the manual of our new software.}\\
\addlinespace
Mon tuteur veut que je travaille dans une nouvelle équipe. & My wants me to work in a new team.\\
\cellcolor{gray!6}{Mon stage a été annulé à cause de la pandémie.} & \cellcolor{gray!6}{My internship was cancelled because of the pandemic.}\\
Il faut que j'en trouve un autre. & I must find another one.\\
\cellcolor{gray!6}{Que cherches-tu ?} & \cellcolor{gray!6}{What are you looking for?}\\
Je cherche le nuancier, je l'ai vu hier sur le bureau. & I am looking for the fan deck, I saw it on the desk yesterday.\\
\addlinespace
\cellcolor{gray!6}{Sur quoi as-tu travaillé la semaine dernière?} & \cellcolor{gray!6}{What did you work on last week?}\\
...
\cellcolor{gray!6}{À quelle heure quittes-tu le bureau, d’habitude?} & \cellcolor{gray!6}{I usually leave the office at 5.}\\
\addlinespace
Connais-tu une autre manière de contacter le fabricant? & Do you know another way to contact the manufacturer?\\
\cellcolor{gray!6}{Attention, ton image chevauche le texte.} & \cellcolor{gray!6}{Be careful, your image is overlapping the text.}\\
Tu devrais voir les nouvelles installations de mon entreprise. & You should see my company’s new facilities.\\
\cellcolor{gray!6}{L'entreprise a commandé 10 000 cartes de visite la semaine dernière.} & \cellcolor{gray!6}{The company ordered 10000 business cards last week.}\\
...
commitment & /010/ & /\textipa{k@."mIt.m@nt}/\\
\cellcolor{gray!6}{standard} & \cellcolor{gray!6}{/10/} & \cellcolor{gray!6}{/\textipa{"st\ae nd.@d}/}\\
...
\cellcolor{gray!6}{species} & \cellcolor{gray!6}{/10/} & \cellcolor{gray!6}{/\textipa{"spi:S.i:z}/}\\
\addlinespace
customer & /100/ & /\textipa{"k2st.@m.@}/\\
\cellcolor{gray!6}{business} & \cellcolor{gray!6}{/10/} & \cellcolor{gray!6}{/\textipa{"bIz.n@s}/}\\
change & /1/ & /\textipa{tSeIndZ}/\\
